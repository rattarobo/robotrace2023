...
void R_Config_GPT4_Create(void)
{
    ...
    GPTW4.GTIOR.LONG = _00000002_GPTn_GTIOCA_COMP_MATCH_HIGH | _00000004_GPTn_GTIOCA_CYCLE_END_LOW | 
                       ...
                       _00020000_GPTn_GTIOCB_COMP_MATCH_HIGH | _00040000_GPTn_GTIOCB_CYCLE_END_LOW | 
    ...
    GPTW4.GTBER.LONG = _00000000_GPTn_GTCCR_BUF_OP_ENABLE | _00000002_GPTn_GTPR_BUF_OP_DISABLE | 
                       _00000004_GPTn_GTADTR_BUF_OP_DISABLE | _00010000_GPTn_GTCCRA_BUF_SINGLE | 
                       _00040000_GPTn_GTCCRB_BUF_SINGLE | _00000000_GPTn_GTPR_BUF_NONE;

    /* Set GPTW4 compare match value */
    GPTW4.GTCCRA = _00007530_GPT4_COMP_MATCH_A_VALUE;
    GPTW4.GTCCRB = _00007530_GPT4_COMP_MATCH_B_VALUE;
    GPTW4.GTCCRD = _00000064_GPT4_COMP_MATCH_D_VALUE;
    GPTW4.GTCCRF = _00000064_GPT4_COMP_MATCH_F_VALUE;

    /* Set GPTW4 GTCCRA buffer value */
    GPTW4.GTCCRC = _00007530_GPT4_COMP_MATCH_A_VALUE;

    /* Set GPTW4 GTCCRB buffer value */
    GPTW4.GTCCRE = _00007530_GPT4_COMP_MATCH_B_VALUE;

    /* Set GPTW4 forcible buffer transfer */
    GPTW4.GTBER.BIT.CCRSWT = 1U;
    ...
    GPTW4.GTINTAD.LONG |= (_00000000_GPTn_ADTRB_DOWNCOUNTING_DISABLE | _00000000_GPTn_ADTRB_UPCOUNTING_DISABLE | 
                          ...
                          _00000000_GPTn_GTCIF_INTERRUPT_DISABLE | _00000000_GPTn_GTCID_INTERRUPT_DISABLE | 
