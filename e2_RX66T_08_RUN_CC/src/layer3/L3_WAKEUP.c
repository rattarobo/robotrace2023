...
void wake_up(void){
	...
	for(short j=0;j<4;j++){
		...
		for(short i=0;i<50;i++){
			mycommand_value.distance[0]+=0.07/50;
			mycommand_value.distance[1]+=0.07/50;
		...
		for(short i=0;i<100;i++){
			mycommand_value.distance[0]=0.08;
			mycommand_value.distance[1]=0.08;
	...
	//
		...
		mycommand_value.velocity[1]=0.1;
		for(short i=0;i<50;i++){
			mycommand_value.distance[0]-=0.085/50;
			mycommand_value.distance[1]-=0.085/50;
