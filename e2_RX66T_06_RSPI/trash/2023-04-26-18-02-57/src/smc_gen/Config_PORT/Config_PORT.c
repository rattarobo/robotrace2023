...
void R_Config_PORT_Create(void)
{
    ...
    /* Set PORTB registers */
    PORTB.PODR.BYTE = _00_Pm1_OUTPUT_0 | _00_Pm4_OUTPUT_0;
    ...
    PORTB.PMR.BYTE = _00_Pm1_PIN_GPIO | _00_Pm4_PIN_GPIO;
    PORTB.PDR.BYTE = _02_Pm1_MODE_OUTPUT | _10_Pm4_MODE_OUTPUT | _80_PDRB_DEFAULT;
