...
void R_Config_MTU0_Create(void)
{
    ...
    MTU0.TCR.BYTE = _00_MTU_CKEG_RISE | _20_MTU_CKCL_A;
    ...
    MTU0.TGRA = _000F_TGRA0_VALUE;
    MTU0.TGRB = _000F_TGRB0_VALUE;
    MTU0.TGRC = _000F_TGRC0_VALUE;
    MTU0.TGRD = _000F_TGRD0_VALUE;
    MTU0.TGRE = _000F_TGRE0_VALUE;
    MTU0.TGRF = _000F_TGRF0_VALUE;
