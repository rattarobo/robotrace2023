...
void get_sensor(_sensorRaw *baffa) {
//	R_Config_DMAC0_Stop();
	SENLED1 = ON;
	SENLED2 = OFF;
	...
	baffa->main[0] =  (int)(temp1[0] - temp0[0]);
	baffa->main[1] =  (int)(temp1[1] - temp0[1]);
	baffa->main[2] =  (int)(temp1[2] - temp0[2]);
	baffa->main[3] =  (int)(temp1[3] - temp0[3]);
	baffa->main[4] =  (int)(temp1[4] - temp0[4]);
	baffa->main[5] =  (int)(temp1[5] - temp0[5]);
	baffa->main[6] =  (int)(temp1[6] - temp0[6]);
	baffa->main[7] =  (int)(temp1[7] - temp0[7]);
	baffa->main[8] =  (int)(temp1[8] - temp0[8]);
	baffa->main[9] =  (int)(temp1[9] - temp0[9]);

	baffa->goal =  (int)(temp1[10] -  temp0[10]);
	baffa->coner = (int)(temp1[11] -  temp0[11]);
