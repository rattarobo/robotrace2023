...
#define _FD_PDR1_DEFAULT         (0xFDU) /* PDR1 default value */
#define _F8_PDR2_DEFAULT         (0xF8U) /* PDR2 default value */
#define _3F_PDR3_DEFAULT         (0x3FU) /* PDR3 default value */
...
#define _FF_PDRA_DEFAULT         (0xFFU) /* PDRA default value */
...
#define _7B_PDRE_DEFAULT         (0x7BU) /* PDRE default value */
