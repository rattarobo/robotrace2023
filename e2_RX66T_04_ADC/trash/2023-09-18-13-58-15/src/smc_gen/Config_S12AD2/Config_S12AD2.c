...
void R_Config_S12AD2_Create(void)
{
    ...
    S12AD2.ADSSTR0 = _27_AD2_SAMPLING_STATE_0;
    S12AD2.ADSSTR1 = _27_AD2_SAMPLING_STATE_1;
    S12AD2.ADSSTR2 = _27_AD2_SAMPLING_STATE_2;
    S12AD2.ADSSTRL = _27_AD2_SAMPLING_STATE_L;
