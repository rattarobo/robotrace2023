...
void R_Config_DMAC0_Create(void)
{
    ...
    ICU.DMRSR0 = _3C_DMAC0_ACTIVATION_SOURCE;
    ...
    DMAC0.DMTMD.WORD = _0000_DMAC_TRANS_MODE_NORMAL | _2000_DMAC_REPEAT_AREA_NONE | _0000_DMAC_TRANS_DATA_SIZE_8 | 
    ...
    IPR(DMAC,DMAC0I) = _0D_DMAC_PRIORITY_LEVEL13;
