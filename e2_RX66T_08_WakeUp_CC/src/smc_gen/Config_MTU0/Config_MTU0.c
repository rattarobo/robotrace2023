...
void R_Config_MTU0_Create(void)
{
    ...
    MTU0.TGRA = _02ED_TGRA0_VALUE;
    MTU0.TGRB = _02ED_TGRB0_VALUE;
    MTU0.TGRC = _02ED_TGRC0_VALUE;
    MTU0.TGRD = _02ED_TGRD0_VALUE;
    MTU0.TGRE = _02ED_TGRE0_VALUE;
    MTU0.TGRF = _02ED_TGRF0_VALUE;
